...
def main(args):
    ...
    # Ưu tiên dùng label mapping từ checkpoint base để giữ mapping nhất quán.
    ...
    # Lưu base checkpoint làm best ban đầu.
    initial_checkpoint = {
        "epoch": 0,
        ...
        "stage": "M8_finetune_v2",
    }

    torch.save(initial_checkpoint, best_path)

    for epoch in range(1, args.epochs + 1):
        print(f"\nM8 Fine-tune Epoch [{epoch}/{args.epochs}]")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="M8 fine-tune BestPIKAModel from M7 checkpoint")
    ...
    parser.add_argument("--output_dir", type=str, default="/content/drive/MyDrive/model/M8_split_finetune_v2")
    parser.add_argument("--best_name", type=str, default="M8_finetune_v2_split_best.pth")
    parser.add_argument("--last_name", type=str, default="M8_finetune_v2_split_last.pth")
