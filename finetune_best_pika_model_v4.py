...
def build_class_weights(
    ...
    """
    exponent = 1.0  -> 1/count      mạnh, dễ overfit lớp hiếm
    exponent = 0.5  -> 1/sqrt(count) nhẹ hơn, phù hợp M10
    exponent = 0.0  -> weight gần như bằng nhau
    """
...
def train_one_epoch(model, loader, criterion, optimizer, scaler, device):
    ...
    pbar = tqdm(loader, desc="M10 Fine-tuning", leave=False)
...
def main(args):
    ...
    initial_checkpoint = {
        ...
        "stage": "M10_sqrt_weight_improved",
    ...
    for epoch in range(1, args.epochs + 1):
        print(f"\nM10 Fine-tune Epoch [{epoch}/{args.epochs}]")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="M10 improved fine-tune from M8 using sqrt class weights")
    ...
    parser.add_argument("--output_dir", type=str, default="/content/drive/MyDrive/model/M10_sqrt_weight_improved")
    parser.add_argument("--best_name", type=str, default="M10_sqrt_weight_split_best.pth")
    parser.add_argument("--last_name", type=str, default="M10_sqrt_weight_split_last.pth")
