...
def main():
    ...
    sample_weights = [1.0 / label_counter[label] for label in train_labels]
    ...
    for class_id in range(num_classes):
        count = label_counter.get(class_id, 1)
    ...
    for epoch in range(EPOCHS):
        ...
        if val_f1 > best_f1:
            ...
            torch.save(model.state_dict(), os.path.join(OUTPUT_DIR, "best_pika_v1_1_model.pth"))
